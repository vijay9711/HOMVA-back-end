...
VALUES (1000, 'http://localhost:8080/api/uploads/1.webp', 2600),
       (2000, 'http://localhost:8080/api/uploads/2.webp', 2700),
       (3000, 'http://localhost:8080/api/uploads/3.webp', 2800),
       (4000, 'http://localhost:8080/api/uploads/4.webp', 2900),
       (5000, 'http://localhost:8080/api/uploads/2.webp', 3000),
       (6000, 'http://localhost:8080/api/uploads/5.webp', 3100),
       (7000, 'http://localhost:8080/api/uploads/6.webp', 3200),
       (8000, 'http://localhost:8080/api/uploads/3.webp', 3300),
       (9000, 'http://localhost:8080/api/uploads/1.webp', 3400),
       (10000, 'http://localhost:8080/api/uploads/6.webp', 3500),
       (11000, 'http://localhost:8080/api/uploads/2.webp', 3600),
       (12000, 'http://localhost:8080/api/uploads/5-2.webp', 3700),
       (13000, 'http://localhost:8080/api/uploads/4.webp', 3800),
       (14000, 'http://localhost:8080/api/uploads/3.webp', 3900),
       (15000, 'http://localhost:8080/api/uploads/2.webp', 4000);
